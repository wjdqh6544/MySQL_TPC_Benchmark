WITH ws AS 
    ...
    GROUP BY  d_year, ws_item_sk, ws_bill_customer_sk ), cs AS 
    ...
    GROUP BY  d_year, cs_item_sk, cs_bill_customer_sk ), ss AS 
...
SELECT ss_sold_year,
        ...
        0) other_chan_qty,
         coalesce(ws_wc,
        0)+coalesce(cs_wc,
        0) other_chan_wholesale_cost,
         coalesce(ws_sp,
        0)+coalesce(cs_sp,
        0) other_chan_sales_price
FROM ss
LEFT JOIN ws
